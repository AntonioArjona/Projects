...
namespace CustomerTaskTLG
{
    public class Customer
    {
        ...
        public Customer(DbDataReader reader, Settings settings)
        {
            ...
            if (!string.IsNullOrEmpty((string)reader["country_code"])) CountryCode = (string)reader["country_code"];
            ...
            if (!string.IsNullOrEmpty((string)reader["country_code"])) contactPoint.Address.CountryCode = (string)reader["country_code"];
            ...
            if (!string.IsNullOrEmpty((string)reader["status"]))
            {
                ...
                if ((string)reader["status"] == "C") Payment.Status = "Closed";
